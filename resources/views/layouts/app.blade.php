...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">🪑 E-Furniture</a>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @auth
                        @if(Auth::user()->role === 'admin')
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.admindashboard') }}">Admin Panel</a></li>
                        <li class="nav-item">
    ...
    <footer class="bg-dark text-white text-center py-3">
        &copy; {{ date('Y') }} E-Furniture. All rights reserved.
    </footer>
